<%-- 
    ...
    Created on : Feb 28, 2017, 6:50:17 PM
    Author     : ramakrishna
--%>
...
<div class="row" style="border-bottom: 1px solid #e31e24;background-color: red">
                    ...
                    <ul class="right" id="right-navigation">
                       ...
                       %>
                        ...
                        <li class="active"><a href="./PatientProfile">VIEW PROFILE</a></li>
                         <li class="active"><a href="searchDoctors.jsp">SEARCH DOCTORS</a></li>
    ...
    <div class="large-12 columns">
       <form>
        ...
        <p class="text-left" style="font-weight: bold;">Doctors Search Here</p>
                    <hr style="border: 1px solid green;">
        
      <div class="row collapse">
        <div class="small-10 columns">
          <input type="text" placeholder="Enter Doctors Name or Department">
        </div>
        ...
        <%
        ArrayList<FormBeans> search=(ArrayList<FormBeans>)request.getAttribute("search");
                   ...
                   <tr>
                       ...
                       <td> <%=rfb.getDoctorCity()%></td>
                        <td><%=rfb.getExp()%></td>
                         ...
                         <td>
                                <a href="bookAppointment.jsp?username=<%=rfb.getDoctorUserName()%>" class="button small">BOOK</a>
