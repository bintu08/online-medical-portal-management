      ...
      <div class="row collapse">
        <div class="small-10 columns">
         <select name="username">
                            ...
                            while (it.hasNext()) {
                                ...
                                <option value="<%=rfb.getUserName()%>"><%=rfb.getUserName()%></option>
                                <%}%>
                            </select>
        </div>
        <div class="small-2 columns">
            <button type="submit"  class="button postfix">Go</button>
              ...
              <form data-abide action="./Resent"method="POST">
                   ...
                   //         while (it1.hasNext()) {
                     ...
                     <div class="name-field">
                        <label>From User Name <small>required</small>
                            <input type="text" name="fromuser" value="<%=rfb.getUserName()%>"required pattern="[a-zA-Z]+" readonly="true">
                        </label>
                        <small class="error">Name is required and must be a string.</small>
                     </div>
                   <div class="name-field">
                        <label>To User Name <small>required</small>
                            <input type="text" name="touser" value="<%=rfb.getDoctorUserName()%>"required pattern="[a-zA-Z]+" readonly="true">
                        </label>
