<%-- 
    ...
    Created on : Mar 2, 2017, 4:37:51 PM
    Author     : ramakrishna
--%>
    ...
    <div class="large-12 columns">
      ...
      <div class="row">
          <div class="large-6 medium-6 small-4 columns large-centered" style="margin-top: 50px;">
              ...
              <div class="row">
    <div class="large-centered large-4 small-4 columns">
        <p class="text-left" style="font-weight: bold;">User Profile Here</p>
                    <hr style="border: 1px solid green;">
                        <%
        ArrayList<FormBeans> profile=(ArrayList<FormBeans>)request.getAttribute("profile");
...
%>
        ...
        <table class="center">
                   <tbody>
                       <tr ><th width="550">Full Name</th><td><%=rfb.getFullName()%></td></tr>
                       <tr><th width="550"> User Name</th><td><%=rfb.getUserName()%></td></tr>
                       <tr><th width="550">Date of Birth</th><td><%=rfb.getDob()%></td></tr>
                       <tr><th width="550">City</th><td><%=rfb.getCity()%></td></tr>
                         <tr><th width="550">E-mail</th><td><%=rfb.getEmail()%></td></tr>
                   </tbody>
         </table>
                         <%}%>
