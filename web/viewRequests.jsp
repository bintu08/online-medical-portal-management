<%-- 
    ...
    Created on : Mar 2, 2017, 8:38:14 PM
    Author     : ramakrishna
--%>
      ...
      <div class="row">
        ...
        <div class="row">
            <div class="large-12 columns">
                ...
                <p  class="text-center" > <% String status=(String)request.getAttribute("message");
        if(status!=null){
      %><%=status%>
      <%} %></p>
                ...
                <table>
                    <tbody>
                        <tr  ><th width="250">Doctor Name</th><th width="250">Patient Name</th><th width="150">Problem</th><th width="250">Age</th><th width="150">City</th><th width="150">Status</th><th width="150"></th></tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="./AcceptRequest?id=<%=rfb.getId()%>" class="button ">Accept</a>
                             
                              </td>
                              <td>
                                <a href="./Consult?userid=<%=rfb.getId()%>&status=<%=rfb.getStatus()%>" class="button ">Consulted</a>
