<%-- 
    Document   : adminRecieved
    Created on : Mar 3, 2017, 12:01:17 PM
    Author     : ramakrishna
--%>
...
<!--         <div class="row"> 
          <div class="large-8 medium-6 small-4 columns large-centered" style="margin-top: 50px;">-->
              <form data-abide action="./PatientSendMessage"method="POST">
                    ...
                    <hr style="border: 1px solid green;">-->
                     ...
                     <div class="name-field">
                        <label>From User Name <small>required</small>
                            <input type="text" name="fromuser" value="<%=username%>"required pattern="[a-zA-Z]+" readonly="true">
                        </label>
                        <small class="error">Name is required and must be a string.</small>
                     </div>
                   <div class="name-field">
                        <label>To User Name <small>required</small>
                            <input type="text" name="touser" value=""required pattern="[a-zA-Z]+" readonly="true">
                        </label>
                        <small class="error">Enter User name is required.</small>
                    </div>
                         <div class="name-field">
                        <label>Time <small>required</small>
                            <input type="text" name="time" value=""required pattern="[a-zA-Z]+" readonly="true">
                        </label>
                        <small class="error">Enter User name is required.</small>
                    </div>
                        <div class="name-field">
                        <label>Received Message <small>required</small>
                            <textarea class="error"rows="4"required name="message" readonly="true"placeholder="Enter Message..."></textarea>
