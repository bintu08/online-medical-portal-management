<%-- 
    ...
    Created on : Feb 27, 2017, 11:21:36 AM
    Author     : ramakrishna
--%>
    ...
    <div class="large-12 columns">
      ...
      <div class="row"> 
          <div class="large-8 medium-6 small-4 columns large-centered" style="margin-top: 50px;">
              <form data-abide action="./NewRegistrationAction"method="POST">
      ...
      <%}%>
                    ...
                    <p class="text-left" style="font-weight: bold;">New Patient Registration Here</p>
                   ...
                   <div class="name-field">
                      ...
                      <div class="name-field">
                        <label>Confirm <small>required</small>
                    ...
                    <div class="name-field">
                      ...
                      <div class="name-field">
                        ...
                        <small class="error">Enter date of birth is required.</small>
                    </div>
                   <div class="button-field">
                            ...
                            <div class="row">
                                ...
                                <div class="large-12 columns">
                                    ...
                                    <button type="submit" class="button radius expand" >CREATE ACCOUNT</button>
